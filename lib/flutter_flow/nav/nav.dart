...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/calenderPage',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'CalenderPage')
              : CalenderPageWidget(),
        ),
        FFRoute(
          name: 'GoogleMapPage',
        ...
        FFRoute(
          name: 'MedicineReminderPage',
          path: '/medicineReminderPage',
          builder: (context, params) => MedicineReminderPageWidget(),
        ),
        FFRoute(
          name: 'HealthCheck',
          path: '/healthCheck',
          builder: (context, params) => HealthCheckWidget(),
        ),
        FFRoute(
          name: 'BmiCheck',
          path: '/bmiCheck',
          builder: (context, params) => BmiCheckWidget(),
        ),
        FFRoute(
          name: 'SuccessPage',
          path: '/successPage',
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Profile13DoctorDetails')
              : Profile13DoctorDetailsWidget(),
        )
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/HealTime_(375__812_px)_(1).png',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
